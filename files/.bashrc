...
# exports
export PATH="${HOME}/.bin:/sbin:/usr/bin:/usr/sbin:/usr/local/bin:${HOME}/.flutter/bin:${HOME}/.android-studio/bin:"
...
alias cd..="cd .."
alias cdtw="cd ~/Programming/Mainline/College/5"
alias cdpy="cd ~/Programming/Sideline/Python"
